% Script for calculating GW contribution to EF with routed BF and
% everything in m/yr
...
%            spatial extend: British Columbia
...
load Upstream_BC % <<See Script_Upstream_Monthly for details>>
