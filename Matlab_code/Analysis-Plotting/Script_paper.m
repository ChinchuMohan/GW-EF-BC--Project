...
% inputs - E1_routed and E2
% See \Estimation\Script_E1_E2_calculation for E1 and E2 calculation
...
E1_perc_precip(E1_perc_precip>=120)=120; % rounding outliers
E2_perc_precip=((E2_myr_mean)./Pre_myr_mean_BC)*100;
E2_perc_precip(E2_perc_precip>=120)=120; % rounding outliers
...
E1_perc_disc=((E1_myr_rout_mean)./discharge_myr_mean)*100; 
